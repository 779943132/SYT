      ...
      <div class="nav-container page-component">
          ...
          <div class="content-wrapper">
              ...
              <el-form-item prop="email" label="邮箱：">
                  <el-input v-model="patient.email" placeholder="请输入邮箱" maxlength="30" class="input v-input"/>
              </el-form-item>
          ...
          <div class="content-wrapper">
              <el-form :model="patient" label-width="110px" label-position="left">
                  ...
                  <el-form-item prop="contactsEmail" label="邮箱：">
                      <el-input v-model="patient.contactsEmail" placeholder="请输入联系人邮箱" class="input v-input"/>
                  </el-form-item>
              </el-form>
          </div>
          </div>
...
import dictApi from '@/api/doctapi'
  ...
  data() {
    return {
      ...
      validateRules: {
        ...
        email: [{ required: true, trigger: 'blur', message: '必须输入' }],
