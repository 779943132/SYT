<template>
      <div class="app-container">
          ...
          stripe
            ...
            <el-table-column label="状态" prop="param.Status"/>
            ...
            <el-table-column label="操作" width="200" align="center">
                  <template slot-scope="scope">
                      ...
                      <el-button v-if="scope.row.status == 1" type="primary" size="mini" @click="lockUserSet(scope.row.id, 0)">锁定</el-button>
                      <el-button v-if="scope.row.status == 0" type="danger" size="mini" @click="lockUserSet(scope.row.id, 1)">取消锁定</el-button>
                  </template>
